...
const Header2 = () => {
  return (
    ...
    <div className='flex flex-wrap items-center py-3 px-4 sm:px-10 bg-[#f3c1f3] lg:gap-y-4 gap-y-6 gap-x-4'>
      <div><Link href={"/"} className='text-[#252B42]'>Bandage</Link></div>
      <div className='flex flex-1 w-full lg:w-auto justify-between items-center ml-4'>      
      <div id="collapseMenu"
        className="max-lg:hidden lg:!flex lg:items-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50 justify-start">
      ...
      <div className='flex items-center max-sm:ml-auto'>
        <ul className="flex space-x-4">
          <li
            ...
            <Image src={"/images/Icn-Search.png"} width={24} height={24} alt='Search'></Image>
          </li>
          <li
            className="relative px-1 lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
            <span className="relative">
              <Image className='cursor-pointer inline-block ' src={"/images/Icn-Cart.png"} width={24} height={22.4} alt='Cart'></Image>
