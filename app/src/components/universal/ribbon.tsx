...
const Ribbon = () => {
  return (
    <section className="bg-[#252B42] min-h-[40px] py-2 hidden lg:flex">
      <div className='wrapper'>
        <div className='flex py-3 px-4 items-center justify-between gap-x-32 w-full'>
      ...
      <span className="border-l h-3 mx-2 xl:mx-4"></span>
