...
//     <>
//       {open && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 z-50 rounded-lg flex items-center justify-center">
//           <div className="max-w-sm w-full bg-white shadow-lg p-6  rounded-lg transform transition-all relative border border-gray-300 ">
//             <button onClick={handleClose} className="absolute top-4 right-4 text-xl font-bold text-slate-700 hover:text-gray-500 transition duration-200">X</button>
