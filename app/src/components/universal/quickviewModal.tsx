...
//       <div className="bg-white rounded-lg shadow-lg relative w-[70%] h-[70%] max-w-[800px] max-h-[600px] p-6 flex flex-col items-center justify-center transition-transform transform scale-95 animate-fadeIn">
//         {/* Close Button */}
//         <button
...
//         {/* Product Description */}
//         <p className="text-sm text-gray-700 text-center max-w-[80%]">{product.description}</p>

//         {/* Price */}
//         <span className="block text-lg font-bold text-green-600 mt-4">${product.price}</span>
//       </div>
//     </div>
//   );
// };
