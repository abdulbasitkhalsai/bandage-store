...
// import type { Rule as ValidationRule } from "@sanity/types"; 
...
//                 `https://${process.env.NEXT_PUBLIC_SANITY_PROJECT_ID}.api.sanity.io/v2022-03-07/data/query/${process.env.NEXT_PUBLIC_SANITY_DATASET}?query=*[_type=="product"]{_id, title}`
//               )
//                 .then((res) => res.json())
//                 .then((data) => data.result || []);
    
//               return products.map((product: { _id: string; title: string }) => ({
//                 title: product.title,
//                 value: product._id, // Store productId as string
//               }));
//             },
//           },
//         },
...
//     defineField({ name: "emailVerified", title: "Email Verified", type: "boolean", initialValue: false, readOnly: true }),
